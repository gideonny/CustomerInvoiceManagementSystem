...
namespace CustomerInvoiceManagementSystem.Entities
{
    public class CustomerInvoiceManagementDbContext : DbContext
    {
        public CustomerInvoiceManagementDbContext(DbContextOptions<CustomerInvoiceManagementDbContext> options) : base(options)
        {
        ...
        {
            //PaymentTerms to Invoice: one-to-many
            ...
            //Invoice ton InvoiceLineItem: One-to-many
